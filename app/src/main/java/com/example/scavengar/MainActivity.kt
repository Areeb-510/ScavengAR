...
//    private val locationPermissionCode = 2
    ...
    private lateinit var clickTest : Button
...
//    private lateinit var sceneView: ArSceneView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        clickTest = findViewById(R.id.testbtn)
        ...
        arscan.setOnClickListener {
            ...
            if(myLocation.checkIsInBound(20.0,oat)){
                ...
                val intent = Intent(this,ScanActivity::class.java)
                intent.putExtra("glbname","mapsnew")
                startActivity(intent)
            }else if(myLocation.checkIsInBound(20.0,dbh)){
                Toast.makeText(this,"DBH",Toast.LENGTH_LONG).show()
                val intent = Intent(this,ScanActivity::class.java)
                intent.putExtra("glbname","dumbbell")
                startActivity(intent)
            }else if(myLocation.checkIsInBound(20.0,opengym)){
                Toast.makeText(this,"OPEN GYM",Toast.LENGTH_LONG).show()
                val intent = Intent(this,ScanActivity::class.java)
                intent.putExtra("glbname","congo")
                startActivity(intent)
            }else{
